...
train_x, train_y, test_x, test_y = utils.prepare_data()
train_x, test_x = utils.color_preprocessing(train_x, test_x)

# image_size = 32, img_channels = 3, class_num = 10 in cifar10
x = tf.placeholder(tf.float32, shape=[None, utils.image_size, utils.image_size, utils.img_channels])
label = tf.placeholder(tf.float32, shape=[None, utils.class_num])
...
with tf.Session() as sess:
    ...
    for epoch in range(1, total_epochs + 1):
        ...
        for step in range(1, iteration + 1):
            ...
            batch_x = utils.data_augmentation(batch_x)
